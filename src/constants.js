...
export const serviceData = [
  {
    ...
    desc: "As an Automation Specialist, I have implemented robust automation frameworks and streamlined data workflows to improve operational efficiency. I’ve developed CI/CD pipelines using GitHub Actions and Jenkins, automated report generation and data ingestion processes using Python and Bash, and created scheduled ETL jobs to reduce manual tasks. My work focuses on enhancing system reliability and accelerating deployment cycles through scripting, orchestration tools, and performance monitoring.",
